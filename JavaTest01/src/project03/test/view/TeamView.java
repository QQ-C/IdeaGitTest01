...
public class TeamView {
    ...
    public static void main(String[] args) {
        project03.demo.view.TeamView view = new project03.demo.view.TeamView();
        view.enterMainMenu();
    }
}
